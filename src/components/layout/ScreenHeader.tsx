...
export default function ScreenHeader(props: NativeStackHeaderProps) {
    ...
    return (
        <View style={{ paddingTop: isFormSheet ? 16 : insets.top }} className='flex-row items-center gap-2 px-4 pb-2 bg-white'>
            {/* {
                hasBackButton && (
                )
            } */}
