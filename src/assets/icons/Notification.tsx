...
const NotificationSvg: React.FC<IconProps> = ({ 
  width, 
  height, 
  size = 20,
  color = "#fff" 
  ...
  <Svg width={width || size} height={height || size} viewBox="0 0 24 24" fill="none">
    ...
    <G clipPath="url(#clip0_1_1405)">
      <Path
        d="M12 6.93994V10.2699"
        stroke={color}
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
      ...
      />
      <Path
        d="M15.3299 19.3201C15.3299 21.1501 13.8299 22.6501 11.9999 22.6501C11.0899 22.6501 10.2499 22.2701 9.64992 21.6701C9.04992 21.0701 8.66992 20.2301 8.66992 19.3201"
        stroke={color}
        strokeWidth="1.5"
        strokeMiterlimit="10"
      />
